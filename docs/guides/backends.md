---
title: Supported Backends | Vault operator
description: Supported Backends for Vault operator
menu:
...
### AWS S3
Vault operator supports AWS S3 service or S3 compatible services like [Minio](https://minio.io/) servers, [Rook Object store](https://rook.io/docs/rook/master/object.html) as backend. To configure this backend, following secret keys are needed:
...
Vault operator supports Google Cloud Storage(GCS) as backend. To configure this backend, following secret keys are needed:
...
Vault operator supports Microsoft Azure Storage as backend. To configure this backend, following secret keys are needed:
...
### OpenStack Swift
Vault operator supports [OpenStack Swift as backend](https://restic.readthedocs.io/en/stable/030_preparing_a_new_repo.html#openstack-swift). To configure this backend, following secret keys are needed:
...
### Backblaze B2
Vault operator supports Backblaze B2 as backend. To configure this backend, following secret keys are needed:
