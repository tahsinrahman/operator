---
title: Minio | Vault operator
description: Using Vault operator with TLS secured Minio Server
menu:
...
You should have understanding the following Vault operator terms:
